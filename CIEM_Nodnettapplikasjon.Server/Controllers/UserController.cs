...
// This controller handles API requests for users and retrieves data from the "Users" table.
// This includes authentication. Might be best to move that to an "AuthenticationController" in the future
