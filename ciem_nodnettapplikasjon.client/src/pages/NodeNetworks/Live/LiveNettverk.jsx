                  ...
                  {showArchiveConfirm && (
                      <div className={styles.confirmModal}>
                          ...
                          <button
                              onClick={async () => {
                                  try {
                                      const res = await fetch(`https://ciem-nodnettapplikasjon.onrender.com/api/NodeNetworks/archive/${networkId}`, {
                                          method: "POST",
                                      });
                                      if (res.ok) {
                  ...
                  {showDeleteConfirm && (
                      <div className={styles.confirmModal}>
                          ...
                          <button
                              onClick={async () => {
                                  try {
                                      const res = await fetch(`https://ciem-nodnettapplikasjon.onrender.com/api/NodeNetworks/delete/${networkId}`, {
                                          method: "DELETE",
                                      });
                                      if (res.ok) {
